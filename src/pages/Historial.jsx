          ...
          {editing && editDraft && (
            <div onClick={e => e.stopPropagation()} style={{ marginTop:14, padding:"16px", borderRadius:12, background:"rgba(255,179,71,0.04)", border:"1px solid rgba(255,179,71,0.2)" }}>
              ...
              <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:10, marginBottom:12 }}>
                {[["Fecha","date","date"],["Ciclo","cycle","text"],["Médico","physician","text"],["Diagnóstico","diagnosis","text"],["# Global","infusionNumber","number"],["Ingreso","ingreso","time"],["Retiro","retiro","time"]]<div style={{ marginBottom:12 }}>
